...
export default function RefreshIcon({ width, height, fill }) {
    return(
        <svg data-testid="refresh-button"  xmlns="http://www.w3.org/2000/svg" width={width || "20"} height={height || "20"} fill={fill || "none"} viewBox="0 0 20 20">
