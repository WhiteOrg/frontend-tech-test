...
- [**NodeJS**](https://nodejs.org/en/) >= 20.18
...
1. Run `npm start` to launch the app to [http://localhost:3000](http://localhost:3000); you should see some text if everything has worked. Edit that page in the `App.js` file and you should see it automatically update in the browser when you hit save 😎
...
Endpoint:
`https://run.mocky.io/v3/0751485f-0dd5-4334-9f92-6367af402ad0`
...
- The first thing you'll have to do is delete the existing title etc. in `App.js`, but also feel free to tidy up respective `.css` files and anything else you don't need.
...
Alternatively, you can create a new private repository on your GitHub account and share it with us, or zip the final project and send it via email.

### What Happens Next?

We'll review your submitted solution against the criteria outlined above and be in touch. If you're solution is successful then you'll be invited to another interview.
